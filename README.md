...
[Open the live demo](https://carethreadatlas.onrender.com/) · [Source repository](https://github.com/carethreadatlas/app)

Follow the thread of a health record.

The record timeline runs on FinchNode. [Explore FinchNode](https://finchnode.com).

## What this app does

Filter the timeline by clinical category, reverse the chronology, and expand any event to inspect its original resource fields.
...
`carethreadatlas.com` was unregistered in the .com registry on 2026-09-08. This is an availability signal, not a reservation; verify the registrar offer before purchasing. No domain has been bought.
