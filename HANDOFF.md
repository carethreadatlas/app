...
- Public site: https://carethreadatlas.com/
...
The canonical origin is https://carethreadatlas.com/. The domain is registered through Squarespace and assigned to this Render site; `www` redirects to the apex domain. Keep `liveUrl` in `content/seo.json`, repository homepage, sitemaps and DNS aligned. The original https://carethreadatlas.onrender.com/ address remains available during migration. Verify HTTPS before publishing domain changes and update the backend origin restrictions before enabling connections on a new domain.
